    ...
    router.post('/permitted/write' ,function(req,res){
        ...
        '<html>' +
            ...
            '<script>' +
                ...
                'function onYouTubeIframeAPIReady(){player=new YT.Player("player",{height:"100%",width:"100%",videoId:"",autoplay:1,events:{onReady:onPlayerReady,onStateChange:onPlayerStateChange,onError:onPlayerError}})}function onPlayerReady(t){playNext(),setInterval(function(){started&&ytNowPlaying&&0!=ytNowPlaying.endSeconds&&1==player.getPlayerState()&&ytNowPlaying.endSeconds<player.getCurrentTime()&&player.pauseVideo()},500)}function onPlayerStateChange(t){t.data==YT.PlayerState.PLAYING?started=!0:t.data==YT.PlayerState.ENDED&&started&&(ytNowPlaying=null,playNext(),started=!1)}function onPlayerError(t){ytNowPlaying=null}function stopVideo(){player.stopVideo()}function playNext(){for(var t=0;t<ytPlaylist.length;t++){var e=ytPlaylist[t];e.isPlaying&&(e.isPlaying=!1,ytToPlay=ytPlaylist[t+1]?ytPlaylist[t+1]:ytPlaylist[0])}null==ytToPlay&&ytNextIfDeleted&&(ytToPlay=ytNextIfDeleted),null==ytToPlay&&(ytToPlay=ytPlaylist[0]),playVideoInPlaylist(ytToPlay)}function playVideoInPlaylist(t){t&&(playingId=t.uuid,t.isPlaying=!0,ytNowPlaying=t,player.loadVideoById(t),ytNextIfDeleted=null)}var ytNowPlaying,playingId,tag=document.createElement("script"),ytNextIfDeleted;tag.src="https://www.youtube.com/iframe_api";var firstScriptTag=document.getElementsByTagName("script")[0];firstScriptTag.parentNode.insertBefore(tag,firstScriptTag);var player,started=!1,ytToPlay=null;' +
            '</script>' +
        '</html>';
